...
//    public NewUserDAO(DatabaseReference databaseReference) {
...
//    }
    ...
    public LiveData<User> getUserById(String id) {
        ...
        databaseRef.child(id).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                User userRes = dataSnapshot.getValue(User.class);
